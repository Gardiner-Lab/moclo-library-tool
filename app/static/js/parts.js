        ...
        <div class="part-detail-section">
            ...
            <div class="detail-grid">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value"><a href="/plasmids?view=${part.plasmid_id}" style="color: var(--primary-color); text-decoration: underline; cursor: pointer;">View Plasmid →</a></span>
                </div>
                ` : ''}
                ${part.level ? `
                <div class="detail-item">
